...
<section class="ftco-section ftco-destination">
	...
	<div class="view">
		...
		<input type="hidden" class="form-control" id="num" value="${theme.num}">
		<h1 align="center">${theme.title}</h1>
		<p align="center">${theme.p}</p><br>
		<div class="form-group" align="center">
			<img src="/busan/resources/upload/${theme.timg}" width="800" height="500">
		</div>
		...
		<div class="item">
			<ul class="menu">
				<li><a href="#" class="review">리뷰(${theme.replyCnt})</a></li>
			</ul>
			<div align="center">
...
$("#reviewBtn").on("click",function(){
	if(${empty sessionScope.sessionId}){ 
		...
		$.ajax({
			type:"post",
			url:"/busan/treview/reviewInsert",
