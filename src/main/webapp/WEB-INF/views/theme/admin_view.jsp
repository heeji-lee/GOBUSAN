...
<section class="ftco-section ftco-destination">
	...
	<div class="view">
		<input type="hidden" class="form-control" id="num" value="${theme.num}" readonly="readonly">
		...
		<div align="right">
			<a href="admin_update?num=${theme.num}"><button type="button" class="btn btn-primary">수정</button></a>
