...
<section class="ftco-section ftco-destination">
	...
	<h1 align="center">공지 상세</h1><br>
	<div class="view">
		<input type="hidden" class="form-control" id="nnum" value="${notice.nnum}">
		<table class="table">
		<thead>
			<tr>
				<th>제목</th>
		...
		<div class="form-group" style="padding: 0 30px; height: 350px;">${notice.content}</div><br>
		<table class="table">
		<thead>
			<tr>
				<th>파일</th>
